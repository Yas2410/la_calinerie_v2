...
class SecurityController extends AbstractController
{
    ...
    public function login(AuthenticationUtils $authenticationUtils): Response
    {
        ...
        return $this->render('front/security/loginAdmin.html.twig', ['last_username' => $lastUsername, 'error' => $error]);
    }
    ...
    /**
     * @Route("/password-reset", name="app_forgotten_password")
     ...
     * @return Response
     */
    public function oubliPass(Request $request, UserRepository $userRepository, Swift_Mailer $mailer,
                              TokenGeneratorInterface $tokenGenerator): Response
    {
        // On initialise le formulaire
        $formResetPass = $this->createForm(ResetPassType::class);
        ...
        return $this->render('front/security/forgotten_password.html.twig',
            ['emailForm' => $formResetPass->createView()]);
    }
    ...
    public function resetPassword(Request $request, string $token, UserPasswordEncoderInterface $passwordEncoder)
    {
        ...
        (User::class)->findOneBy(['resetToken' => $token]);
